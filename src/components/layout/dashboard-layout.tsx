...
import { Home, FileText, Plus, Settings, User, LogOut, Moon, Sun, TrendingUp, Bell } from "lucide-react"
    ...
    <Sidebar className="border-r border-slate-200 dark:border-slate-800">
      <SidebarHeader className="border-b border-slate-200 dark:border-slate-800 p-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-slate-900 dark:text-white">BragDoc</span>
        </div>
      </SidebarHeader>
      ...
      <SidebarFooter className="border-t border-slate-200 dark:border-slate-800 p-4">
        <div className="flex items-center space-x-3">
          <Avatar className="w-8 h-8">
            ...
            <AvatarFallback className="bg-indigo-100 text-indigo-600 text-sm font-semibold">JD</AvatarFallback>
          </Avatar>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-10 w-10 rounded-xl">
                <Avatar className="h-10 w-10">
                  ...
                  <AvatarFallback className="bg-indigo-100 text-indigo-600 font-semibold">JD</AvatarFallback>
                </Avatar>
              </Button>
            </DropdownMenuTrigger>
