...
// import { Chrome, Key, Mail, Moon, Sun, TrendingUp, User } from "lucide-react";
...
//       <div className="flex m-auto flex-col max-w-xl p-8 space-y-8">
//         <div className="flex items-center space-x-4 absolute top-8 right-8">
//           <Button
//             variant="ghost"
//             size="icon"
